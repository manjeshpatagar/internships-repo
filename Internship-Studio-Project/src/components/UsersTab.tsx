                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-600">
                        ...
                        <div className="flex items-center gap-2"><Calendar className="w-4 h-4" />Joined: {user.joinDate}</div>
                        {user.college && (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button variant="outline" size="sm" onClick={() => deleteUser(user.id)} className="text-red-600 hover:text-red-800"><Trash2 className="w-4 h-4" /></Button>
                    </div>
                  </div>
                </Card>
              ))}
